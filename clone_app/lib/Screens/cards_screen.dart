  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      ...
      Column(children: [
        ...
        Container(color: Color(0xff024d91),
        width: 500,
          child: Row(
        ...
        Row(
          ...
          children: [
             Text("بطاقات إمكان",style: TextStyle(fontSize: 15,color: Color(0xffe2c38c)),),
          Text(" urpay بطاقه",style: TextStyle(fontSize: 15,color: Color(0xffdfae64))),
  ...
  child: ClipRRect(
    ...
    ,Padding(
      ...
      child: Row(
        ...
        children: [
          ClipRRect(borderRadius: BorderRadiusDirectional.circular(8),
            child: Container(color: Color(0xffffffff),height: 50,width: 166,
            child: Row(mainAxisAlignment: MainAxisAlignment.center,
              ...
              Icon(Icons.settings,color: Color(0xfff2a542),)
        ...
        children: [
          ClipRRect(borderRadius: BorderRadiusDirectional.circular(8),
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.center,
              ...
              Icon(Icons.lock_outline,color: Color(0xfff2a542),)  
            ],)
            )
            ),
      ],),
          ...
          Container(
            ...
            child: ListView(
              ...
              ClipRRect(
                ...
                child: Container(color: Color(0xffffffff),height: 1000,width: 300,
                child: Padding(
                  padding: const EdgeInsets.all(16.0),
                  ...
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    ...
                    children: [
                       Text("عرض الكل",style: TextStyle(color: Color(0xffdcb577)),),
                       Spacer(),
